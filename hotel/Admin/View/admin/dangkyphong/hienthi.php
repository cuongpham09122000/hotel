...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <h4>DANH SÁCH KHÁCH HÀNG ĐẶT PHÒNG</h4>
    ...
    <table>
        <tr>
            <th rowspan="2">STT</th>
            <th rowspan="2">Mã đặt phòng</th>
            <th rowspan="2">Tên khách hàng</th>
            <th rowspan="2">Loại Phòng thuê</th>
            <th rowspan="2">Ngày đăng ký</th>
            <th rowspan="2">Ngày Nhận phòng</th>
            <th rowspan="2">Ngày trả phòng</th>
            <th rowspan="2">Số lượng phòng</th>
        ...
        <tr>
            <th class="addnew" colspan="2"><a href="#">Add New</a></th>
        </tr>
        ...
        include '../../../Model/function_dangkyphong.php';
            ...
            {
                $madp=$_POST['key'];
                $sql="select * from qlks_phieuxacnhandatphong where ma_datphong='".$madp."'";
            }
            if(empty($_POST['key']))
            {
                $sql="select * from qlks_phieuxacnhandatphong";
            }

            $data=Hienthi_DKphong($sql);
            $i=1;
            foreach ($data as $value){
                $key=$value['ma_datphong'];
                echo " <tr>
                <td>".$i++."</td>
                <td>".$value['ma_datphong']."</td>
                <td>".$value['hoten_khachhang']."</td>
                <td>".$value['loaiphong']."</td>
                <td>".$value['ngay_dk']."</td>               
                <td>".$value['ngay_nhanphong']."</td>
                <td>".$value['ngay_traphong']."</td>
                <td>".$value['soluong_phong']."</td>
                <td>".$value['CCCD']."</td>
                ...
                <td>".$value['diachi']."</td>
                <td class='edit'><a href='edit_datphong.php?ma_datphong=$key'> edit</a></td>
                <td class='del'><a href='del_datphong.php?ma_datphong=$key'> delete</a></td>
            </tr>";
            }
            ?>
