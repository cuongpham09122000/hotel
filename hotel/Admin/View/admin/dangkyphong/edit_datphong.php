...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
           ...
           with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./hienthi.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Danh sách</p>
                                    </a>
                                </li>
    ...
    <?php
    require '../../../Model/function_dangkyphong.php';
    $key=$_REQUEST['ma_datphong'];
    $sql="select * from qlks_phieuxacnhandatphong where ma_datphong='".$key."'";
    $data= Hienthi_DKphong($sql);
    foreach($data as $value){
    ?>
    <section>
    <center>
        <h1>
            NHẬP THÔNG TIN KHÁCH HÀNG CẦN SỬA
        </h1>
        <form action="" method="POST" name="">
            <table width="60%" height="250">
                <tr>
                    <td>Mã đặt phòng</td>
                    <td><input type="text" name="txtmadp" size="60" placeholder="nhập mã đặt phòng...."
                    value="<?php echo $value['ma_datphong'];?>" ></td>
                </tr>

                <tr>
                    <td>Tên khách hàng</td>
                    <td><input type="text" name="txttenkh" size="60" placeholder="nhập tên khách hàng...."
                    value="<?php echo $value['hoten_khachhang'];?>"></td>
                </tr>


                <tr>
                    <td>Ngày đăng ký</td>
                    <td><input type="text" name="txtngaydk" size="60" placeholder="nhập ngày đăng ký...."
                    value="<?php echo $value['ngay_dk'];?>"></td>
                </tr>
                <tr>
                    <td>Ngày nhận phòng</td>
                    <td><input type="text" name="txtngaynp" size="60" placeholder="nhập ngày nhận phòng...."
                    value="<?php echo $value['ngay_nhanphong'];?>"></td>
                </tr>
                <tr>
                    <td>Ngày trả phòng</td>
                    <td><input type="text" name="txtngaytp" size="60" placeholder="nhập ngày trả phòng...."
                    value="<?php echo $value['ngay_traphong'];?>"></td>
                </tr>
                <tr>
                    <td>Số lượng phòng</td>
                    <td><input type="text" name="txtslphong" size="60" placeholder="nhập số lượng phòng...."
                    value="<?php echo $value['soluong_phong'];?>"></td>
                </tr>
                <tr>
                    <td>CCCD</td>
                    <td><input type="text" name="txtcccd" size="60" placeholder="Nhập căn cước công dân...."
                ...
                <tr>
                    <td>Giới tính</td>
                    <td><input type="text" name="txtgioitinh" size="60" placeholder="Nhập giới tính...."
                    value="<?php echo $value['gioitinh'];?>"></td>
                </tr>
               
                <tr>
                    <td>Địa chỉ</td>
                    <td><input type="text" name="txtdiachi" size="60" placeholder="Nhập địa chỉ"
   ...
   <?php
    if(isset($_POST['btUpdate']))
    {
            ...
            $ngaynp = $_POST['txtngaynp'];
            $ngaytp = $_POST['txtngaytp'];
            $slphong = $_POST['txtslphong'];
            $cccd = $_POST['txtcccd'];
            ...
            $result = Update_DKphong($tenkh,$loaiphong,$ngaydk,$ngaynp,$ngaytp,$slphong,$cccd,$ngaysinh,$sdt,$email,$gioitinh,$diachi,$key);
            if($result)
            {
                header('Location:hienthi.php'); // điều hướng trang
            }
            else
            {
                echo "lỗi update";
