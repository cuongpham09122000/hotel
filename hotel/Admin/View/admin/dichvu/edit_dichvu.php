...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
           ...
           with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./add_dichvu.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Thêm</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./list_dichvu.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Danh sách</p>
                                    </a>
                                </li>
    ...
    <?php
    require '../../../Model/function_dichvu.php';
    $key=$_REQUEST['ma_dichvu'];
    $sql="select * from qlks_dichvu where ma_dichvu='".$key."'";
    $data= Hienthi_Dichvu($sql);
    ...
    <center>
        ...
        <form action="" method="POST" name="">
            <table width="60%" height="250">
                <tr>
                    <td>Mã dịch vụ</td>
                    <td><input type="text" name="txtmadv" size="60" placeholder="nhập mã phòng...."
                    value="<?php echo $value['ma_dichvu'];?>" ></td>
                </tr>
                <tr>
                    <td>Ảnh dịch vụ</td>
                    <td><input type="file" name="txtanhdv" size="60" 
                    value="<?php echo $value['anh_dichvu'];?>"></td>
                </tr>
                <tr>
                    <td>Tên dịch vụ</td>
                    <td><input type="text" name="txttendv" size="60" placeholder="nhập tên khoa...."
                    value="<?php echo $value['ten_dichvu'];?>"></td>
                </tr>
               
                <tr>
                    <td>Giá dịch vụ</td>
                    <td><input type="text" name="txtgiadv" size="60" placeholder="Nhập loại phòng"
                    value="<?php echo $value['gia_dichvu'];?>"></td>
                </tr>
                <tr>
                    <td>Ghi chú dịch vụ</td>
                    <td><input type="text" name="txtghichudv" size="60" placeholder="Nhập trạng thái phòng...."
                    value="<?php echo $value['ghichu_dichvu'];?>"></td>
                </tr>
                <tr>
   ...
   <?php
    ...
    {
            $madv=$_POST['txtmadv'];
            $anhdv=$_POST['txtanhdv'];
            $tendv=$_POST['txttendv'];
            $giadv=$_POST['txtgiadv'];
            $ghichudv=$_POST['txtghichudv'];

            $result=Update_Dichvu($anhdv,$tendv,$giadv,$ghichudv,$key);
            if($result)
            {
                header('Location:list_dichvu.php'); // điều hướng trang
            }
            else
            {
                echo "lỗi cập nhật";
