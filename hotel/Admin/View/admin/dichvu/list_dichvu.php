...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
		...
		<!-- end header  -->
    <section>
    <div id="form_phong" style="float: right; width:70%;">
    ...
    <table>
        <tr>
            <th rowspan="2">STT</th>
            <th rowspan="2">Mã dich vụ</th>
            <th rowspan="2">Ảnh dịch vụ</th>
            <th rowspan="2">Tên dịch vụ</th>
            <th rowspan="2">Giá dịch vụ</th>
            <th rowspan="2">Ghi chú dịch vụ</th>
            <th colspan="2">Action</th>
        </tr>
        <tr>
            <th class="addnew" colspan="2"><a href="add_dichvu.php">Add New</a></th>
        </tr>
        ...
        include '../../../Model/function_dichvu.php';
            ...
            {
                $madv=$_POST['key'];
                $sql="select * from qlks_dichvu where ma_dichvu='".$madv."'";
            }
            if(empty($_POST['key']))
            {
                $sql="select * from qlks_dichvu";
            }
            ...
            foreach ($data as $value){
                ...
                <td><img width='150px' height='120px' src='../uploads/".$value['anh_dichvu']."'></td>
                <td>".$value['ten_dichvu']."</td>               
                <td>".$value['gia_dichvu']."</td>
                <td>".$value['ghichu_dichvu']."</td>
                <td class='edit'><a href='edit_dichvu.php?ma_dichvu=$key'> edit</a></td>
                <td class='del'><a href='del_dichvu.php?ma_dichvu=$key'> delete</a></td>
            </tr>";
            }
            ?>
