...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <center>
        <h4>
            NHẬP THÔNG TIN DỊCH VỤ CẦN THÊM
        </h4>
        <form action="" method="POST" name="">
            <table width="60%" height="250">
                <tr>
                    <td>Mã dịch vụ</td>
                    <td><input type="text" name="txtmadv" size="30" placeholder="nhập mã dịch vụ...." ></td>
                </tr>
            
                <tr>
                    <td>Ảnh dịch vụ</td>
                    <td><input type="file" name="txtanhdv" size="60" ></td>
                </tr>
                <tr>
                    <td>Tên dịch vụ</td>
                    <td><input type="text" name="txttendv" size="60" placeholder="nhập tên dịch vụ...."></td>
                </tr>

                <tr>
                    <td>Giá dịch vụ</td>
                    <td><input type="text" name="txtgiadv" size="60" placeholder="Nhập giá dịch vụ"></td>
                </tr>
                <tr>
                    <td>ghichu_dichvu</td>
                    <td><input type="text" name="txtghichudv" size="60" placeholder="Nhập ghi chú...."></td>
                </tr>
   ...
   require '../../../Model/function_dichvu.php';
    if(isset($_POST['btadd']))
    {
            ...
            $result=Insert_Dichvu($madv,$anhdv,$tendv,$giadv,$ghichudv);
            if($result)
            {
