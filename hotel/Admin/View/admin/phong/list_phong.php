...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <table>
        <tr>
            <th rowspan="2">STT</th>
            <th rowspan="2">Mã phòng</th>
            <th rowspan="2">Tên phòng</th>
            <th rowspan="2">Ảnh phòng</th>
            <th rowspan="2">Loại phòng</th>
            <th rowspan="2">Trạng thái phòng</th>
            <th rowspan="2">Giá phòng</th>
            <th rowspan="2">Mã nhân viên</th>
            <th colspan="2">Action</th>
        </tr>
        <tr>
            <th class="addnew" colspan="2"><a href="add_phong.php">Add New</a></th>
        </tr>
        ...
        include '../../../Model/function_phong.php';
            ...
            {
                $maph=$_POST['key'];
                $sql="select * from qlks_phong where ma_phong='".$maph."'";
            }
            if(empty($_POST['key']))
            {
                $sql="select * from qlks_phong";
            }
            ...
            foreach ($data as $value){
                ...
                echo " <tr>
                <td>".$i++."</td>
                <td>".$value['ma_phong']."</td>
                <td>".$value['ten_phong']."</td>
                <td><img width='150px' height='120px' src='../uploads/".$value['anh_phong']."'></td>
                <td>".$value['loai_phong']."</td>
                <td>".$value['trangthai_phong']."</td>
                <td>".$value['giaphong']."</td>
                <td>".$value['ma_nhanvien']."</td>
                <td class='edit'><a href='edit_phong.php?ma_phong=$key'> edit</a></td>
                <td class='del'><a href='del_phong.php?ma_phong=$key'> delete</a></td>
            </tr>";
            }
            ?>
