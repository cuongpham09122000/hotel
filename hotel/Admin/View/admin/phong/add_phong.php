...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <center>
        ...
        <form action="" method="POST" name="">
            <table width="60%" height="250">
                <tr>
                    <td>Mã phòng</td>
                    <td><input type="text" name="txtmaph" size="30" placeholder="nhập mã phòng...." ></td>
                </tr>
                <tr>
                    <td>Tên phòng</td>
                    <td><input type="text" name="txttenph" size="60" placeholder="nhập tên phòng...."></td>
                </tr>
                <tr>
                    <td>Ảnh_phong</td>
                    <td><input type="file" name="txtanhph" size="60" ></td>
                </tr>
                <tr>
                    <td>Loại phòng</td>
                    <td><input type="text" name="txtloaiphong" size="60" placeholder="Nhập loại phòng"></td>
                </tr>
                <tr>
                    <td>Trạng thái phòng</td>
                    <td><input type="text" name="txtttphong" size="60" placeholder="Nhập trạng thái phòng...."></td>
                </tr>
                <tr>
                    <td>Giá phòng</td>
                    <td><input type="text" name="txtgiaphong" size="60" placeholder="Nhập giá phòng...."></td>
                </tr>
                <tr>
                    <?php
   ...
   <?php
    ...
    if(isset($_POST['btadd']))
    {
            ...
            $manv=$_POST['sl_manv'];
            $result=Insert_Phong($maph,$tenph,$anhphong,$loaiph,$ttphong,$giaphong,$manv);
            if($result)
            {
