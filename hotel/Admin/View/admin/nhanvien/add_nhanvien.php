...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <center>
        ...
        <form action="" method="POST" name="">
            <table width="60%" height="250">
                <tr>
                    <td>Mã nhân viên</td>
                    <td><input type="text" name="txtmanv" size="30" placeholder="nhập mã nhân viên...." ></td>
                </tr>
                <tr>
                    <td>Tên nhân viên</td>
                    <td><input type="text" name="txttennv" size="60" placeholder="nhập tên nhân viên...."></td>
                </tr>
                <tr>
                    <td>Ảnh nhân viên</td>
                    <td><input type="file" name="txtanhnv" size="60" ></td>
                </tr>
                <tr>
                    <td>Ngày sinh</td>
                    <td><input type="text" name="txtngaysinh" size="80" placeholder="Nhập ngày sinh"></td>
                </tr>
                <tr>
                    <td>Địa chỉ</td>
                    <td><input type="text" name="txtdiachi" size="60" placeholder="Nhập địa chỉ...."></td>
                </tr>
                <tr>
                    <td>CCCD</td>
                    <td><input type="text" name="txtcccd" size="60" placeholder="Nhập văn cước công dân...."></td>
                </tr>
                <tr>
                    <td>Số điện thoại</td>
                    <td><input type="text" name="txtsdt" size="60" placeholder="Nhập só điện thoại...."></td>
                </tr>
                <tr>
                    <td>email</td>
                    <td><input type="email" name="txtemail" size="60" placeholder="Nhập email...."></td>
                </tr>
                <tr>
                    <td>Chức vụ</td>
                    <td><input type="text" name="txtchucvu" size="60" placeholder="Nhập chức vụ...."></td>
                </tr>
                <tr>
                    <td>Lương nhân viên</td>
                    <td><input type="text" name="txtluongnv" size="60" placeholder="Nhập lương nhân viên...."></td>
                </tr>
                ...
                <tr>
                    <td>&ensp;</td>
                    <td class="note"><input type="submit" name="btadd" value="ADD">
   ...
   <?php
    ...
    if(isset($_POST['btadd']))
    {
            ...
            $madv=$_POST['sl_madv'];
            $result=Insert_Nhanvien($manv,$tennv,$anhnv,$ngaysinh,$diachi,$cccd,$sdt,$email,$chucvu,$luongnv,$madv);
            if($result)
            {
